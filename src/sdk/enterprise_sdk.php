...
class Enterprise_API extends Softaculous_API
{
     ...
     * @return null
     */
    public function Enterprise_API($url, $key, $pass)
    {
     ...
     * @return null
     */
    public function switchUser($username = '', $owner = '')
    {
     ...
     */
    public function createSession($username, $owner = '', $ip_address = '')
    {
     ...
     */
    public function adddomain($domain, $username, $path, $backup_dir, $replace_path, $data_dir)
    {
     ...
     */
    public function delete_domain($domain, $delowner, $deluser)
    {
        ...
        // Make a call
        $act = 'act=listdomains&delowner='.$delowner.'&deluser='.$deluser.'&delid='.$domain_list[$domain]['did'];
     ...
     */
    public function adduser($username, $email, $uid, $gid, $num_users = 0)
    {
        // Make a call
        $act = 'act=adduser';
     ...
     *                If the key 'error' is NOT EMPTY, there was an error
     */
    public function deleteuser($username, $owner = '')
    {
     ...
     *                If the key 'error' is NOT EMPTY, there was an error
     */
    public function edituser($owner, $username, $uid, $gid, $num_user = 0)
    {
        return $this->curl_unserialize('act=listuser&nof='.$num_user.'&moduser='.$username.'&modowner='.$owner.'&uid='.$uid.'&gid='.$gid);
    }
...
/*
$rsdk = new Remote_API('http://127.0.0.1/soft/softaculous/enduser/index.live.php', 'pirrehjhzrkgwztr', 'odxzhipr4nhntkrcx1zjvf4cxysgaffd');
