...
class Remote_API extends Softaculous_API
{
     ...
     * @return null
     */
    public function Remote_API($url, $key, $pass)
    {
     ...
     */
    public function adddomain($domain, $ftp_user, $ftp_pass, $ftp_path, $backup_path, $data_dir, $protocol = 'ftp', $port = '21', $public_key = '', $private_key = '', $passphrase = '')
    {
     ...
     */
    public function edit_domain($domain, $ftp_user, $ftp_pass, $ftp_path, $backup_path, $data_dir, $protocol = 'ftp', $port = '21', $public_key = '', $private_key = '', $passphrase = '')
    {
     ...
     */
    public function adduser($username, $email, $num_users = 0)
    {
        // Make a call
        $act = 'act=adduser';
     ...
     *                If the key 'error' is NOT EMPTY, there was an error
     */
    public function edituser($username, $num_user = 0)
    {
