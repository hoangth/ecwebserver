...
class Remote_API extends Softaculous_API{
	 ...
	 */
	function adddomain($domain, $ftp_user, $ftp_pass = '', $ftp_path, $backup_path, $data_dir, $protocol = 'ftp', $port = '21', $public_key = '', $private_key = '', $passphrase = ''){
	 ...
	 */
	function edit_domain($domain, $ftp_user, $ftp_pass, $ftp_path, $backup_path, $data_dir, $protocol = 'ftp', $port = '21', $public_key = '', $private_key = '', $passphrase = ''){
